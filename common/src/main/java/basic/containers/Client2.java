...
public class Client2 {
    public static void main(String[] args) {
        ...
        WeakReference<Apple> appleWeakReference = new WeakReference<Apple>(new Apple("苹果1"), appleReferenceQueue);
        WeakReference<Apple> appleWeakReference2 = new WeakReference<Apple>(new Apple("苹果2"), appleReferenceQueue);
