...
public class NoJsonPropertyTest {
    private static final Logger logger = LoggerFactory.getLogger(NoJsonPropertyTest.class);

    private static final ObjectMapper objectMapper = new ObjectMapper();
    private static final String expected = "{\"id\":12345}";
