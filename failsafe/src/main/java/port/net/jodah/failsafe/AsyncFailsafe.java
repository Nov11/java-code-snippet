...
import port.net.jodah.failsafe.Functions.AsyncCallableWrapper;
import port.net.jodah.failsafe.function.*;
import port.net.jodah.failsafe.internal.util.CancellableFuture;
...
public class AsyncFailsafe<R> extends AsyncFailsafeConfig<R, AsyncFailsafe<R>> {
   ...
   */
  public <T> java.util.concurrent.CompletableFuture<T> future(
      ContextualCallable<? extends CompletionStage<T>> callable) {
    return call(Functions.asyncOfFuture(callable));
  }
  ...
  public <T> java.util.concurrent.CompletableFuture<T> futureAsync(
      AsyncCallable<? extends CompletionStage<T>> callable) {
    return call(Functions.asyncOfFuture(callable));
  }
  ...
  private <T> java.util.concurrent.CompletableFuture<T> call(AsyncCallableWrapper<T> callable) {
    ...
    java.util.concurrent.CompletableFuture<T> response = CancellableFuture.of(future);
