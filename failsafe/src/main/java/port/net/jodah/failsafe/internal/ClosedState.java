 ...
 */
package port.net.jodah.failsafe.internal;

import port.net.jodah.failsafe.CircuitBreaker;
import port.net.jodah.failsafe.CircuitBreaker.State;
import port.net.jodah.failsafe.internal.util.CircularBitSet;
import port.net.jodah.failsafe.util.Ratio;
